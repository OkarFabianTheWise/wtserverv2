 ...
 */
function validateAnimationScript(script: any): AnimationScript {
    ...
    return script as AnimationScript;
}

/**
 * Ensures scenes use valid component types from our library
 */
function normalizeComponentTypes(script: AnimationScript): AnimationScript {
 ...
 */
function validateTimings(script: AnimationScript): AnimationScript {
 ...
 */
export async function processCodeWithOpenAI(text: string): Promise<AnimationScript> {
 ...
 */
export function msToFrames(durationMs: number, fps: number = 30): number {
 ...
 */
export function generateCompositionConfig(script: AnimationScript) {
    return {
 ...
 */
export function getUsedCharacters(script: AnimationScript): string[] {
 ...
 */
export function getUsedBuildings(script: AnimationScript): string[] {
 ...
 */
export function getAnimationSummary(script: AnimationScript) {
    return {
 ...
 */
export async function setupRemotionV2(script: string): Promise<{
    title: string;
