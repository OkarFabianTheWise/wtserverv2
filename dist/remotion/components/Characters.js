...
export const AppCharacter = ({ x, y, scale = 1, emotion = 'happy' }) => {
    ...
    return (_jsx("div", { style: {
            ...
            }, children: [_jsxs("div", { style: { position: 'absolute', top: 15, left: 15 }, children: [_jsxs("div", { style: { display: 'flex', gap: '15px' }, children: [_jsx("div", { style: {
                                        width: 8,
...
export const ChefCharacter = ({ x, y, scale = 1, emotion = 'happy', holdingTray = false, isWalking = false, walkingDirection = 'right' }) => {
    const frame = useCurrentFrame();
    ...
    return (_jsxs("div", { style: {
            ...
            transformOrigin: 'center',
                    ...
                    position: 'relative',
                    boxShadow: '0 4px 8px rgba(0,0,0,0.3)',
                }, children: [_jsxs("div", { style: { position: 'absolute', top: 20, left: 15 }, children: [_jsxs("div", { style: { display: 'flex', gap: '15px' }, children: [_jsx("div", { style: { width: 8, height: 8, backgroundColor: '#1F2937', borderRadius: '50%' } }), _jsx("div", { style: { width: 8, height: 8, backgroundColor: '#1F2937', borderRadius: '50%' } })] }), _jsx("div", { style: {
                                    marginTop: 10,
                                    marginLeft: 5,
                                    width: 20,
                                    height: 8,
...
export const CustomerCharacter = ({ x, y, scale = 1, emotion = 'neutral' }) => {
    const frame = useCurrentFrame();
    const bob = Math.sin(frame / 5) * 3;
    return (_jsx("div", { style: {
            position: 'absolute',
            ...
            transform: `scale(${scale})`,
                ...
                position: 'relative',
                boxShadow: '0 4px 8px rgba(0,0,0,0.3)',
            }, children: _jsxs("div", { style: { position: 'absolute', top: 15, left: 15 }, children: [_jsxs("div", { style: { display: 'flex', gap: '15px' }, children: [_jsx("div", { style: { width: 8, height: 8, backgroundColor: 'white', borderRadius: '50%' } }), _jsx("div", { style: { width: 8, height: 8, backgroundColor: 'white', borderRadius: '50%' } })] }), _jsx("div", { style: {
                            marginTop: 8,
                            marginLeft: 5,
                            width: 20,
                            height: 8,
...
export const WorkerCharacter = ({ x, y, scale = 1, emotion = 'neutral', color = '#F59E0B' }) => {
    const frame = useCurrentFrame();
    const bob = Math.sin(frame / 5) * 3;
    return (_jsxs("div", { style: {
            position: 'absolute',
            ...
            transform: `scale(${scale})`,
                    ...
                    position: 'relative',
                    boxShadow: '0 4px 8px rgba(0,0,0,0.3)',
                }, children: _jsx("div", { style: { position: 'absolute', top: 15, left: 15 }, children: _jsxs("div", { style: { display: 'flex', gap: '15px' }, children: [_jsx("div", { style: { width: 8, height: 8, backgroundColor: 'white', borderRadius: '50%' } }), _jsx("div", { style: { width: 8, height: 8, backgroundColor: 'white', borderRadius: '50%' } })] }) }) })] }));
};
